...
main() {
    ...
    KEY_NAME="awslogin06"
    SUBNET_ID="subnet-0061e0005decbaa30"
    SECURITY_GROUP_IDS="sg-00b03fa201afa4755" # Add your security group IDs separated by space
    INSTANCE_NAME="EC2-Test-Machine"
